...
<div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
    <h2 class="text-2xl font-bold mb-6 text-gray-700">Cadastrar Novo Livro</h2>

    <form action="{{ route('livros.store') }}" method="POST" class="space-y-4">
        @csrf

        <div>
            <label class="block text-sm font-semibold text-gray-600 mb-1">Título *</label>
            <input type="text" name="titulo" value="{{ old('titulo') }}" required class="w-full p-2 border rounded focus:outline-blue-500">
        ...
        <div>
            ...
            <input type="text" name="autor" value="{{ old('autor') }}" required class="w-full p-2 border rounded focus:outline-blue-500">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" name="ano_publicacao" value="{{ old('ano_publicacao') }}" required class="w-full p-2 border rounded focus:outline-blue-500">
            ...
            <div>
                ...
                <input type="text" name="genero" value="{{ old('genero') }}" class="w-full p-2 border rounded focus:outline-blue-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" name="quantidade_paginas" value="{{ old('quantidade_paginas') }}" class="w-full p-2 border rounded focus:outline-blue-500">
        ...
        <div class="flex justify-end space-x-3 pt-4">
            ...
            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 cursor-pointer">Salvar Livro</button>
        </div>
    </form>
</div>
@endsection
